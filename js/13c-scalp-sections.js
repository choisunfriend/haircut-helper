...
const VIEWCAL_ANCHOR = {
  ...
  /* ⚠ (2026-09-06 3차) <b>부호가 뒤집혀 있었다</b> — 사용자: "35px 이동했는데
     반대쪽으로 이동시켰네." 아래 식이 cxUse(이미지→모델 매핑의 원점)를 밀고,
     mx = (px − cxUse)·sX 이라 cxUse를 <b>+</b>로 밀면 가닥은 <b>−x</b>로 간다.
     밀고 싶은 방향과 손잡이의 부호가 반대다. 크기(35)는 눈으로 맞춘 그 값
     그대로 두고 방향만 되돌린다 — 크기가 틀렸다는 증거는 아직 없다. */
